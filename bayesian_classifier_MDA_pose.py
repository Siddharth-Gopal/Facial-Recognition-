...
def MDA(data_group, data_cent, num_components = 250, reg = 0.01):
    ...
    data_reduced = np.dot(data_cent[:,:-1], linear_discriminants.T)

    return data_reduced, linear_discriminants
...
data_group = data_grouping(data_cent, labels)

data_reduced, linear_discriminants = MDA(data_group, data_cent)
